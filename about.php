...
<body class="body">
    ...
    <div class="row">
        <header class="col-12 col-s-12 header2">
            <img class="header__bg" src="service.jpg" alt="Saint George Orthodox Russian Church"/>
            <?php include 'Menu.php'; ?>
        </header>
    </div>

    <div class="row">
<main class="col-12 col-s-12 borderimage about-banner">
	<div class="row">
...
<div class="row">
<iframe class="iframe-video" width="100%"  src="https://www.youtube.com/embed/-D2_L5w-Bus?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>
    ...
    <div class="col-12">
		...
		<h2>The Holy Great-Martyr George the Trophy-Bearer </h2>
         ...
         <p>
<em>Commemorated on April 23</em><br>
